    ...
    days: [
      // ===== JOUR 1 — Mercredi 4 juin : Arriv\u00e9e + La Caleta =====
      {
        ...
        activities: [
          ...
          { time: '15:15', period: 'Apr\u00e8s-midi', name: 'Arco de Tajao', query: 'Arco de Tajao Tenerife', lat: 28.1157, lng: -16.4729, desc: 'Arche rocheuse naturelle sculpt\u00e9e par l\'\u00e9rosion, en bord de mer. Moins de 5 min de marche. Premier spot photo.' },
          ...
          { time: '16:15', period: 'Apr\u00e8s-midi', name: 'Check-in Airbnb', query: 'Playa San Juan Tenerife', lat: 28.1810, lng: -16.8050, desc: 'Installation dans le logement \u00e0 Costa Adeje / Playa San Juan.' },
          { time: '17:00', period: 'Apr\u00e8s-midi', name: 'Playa del Duque', query: 'Playa del Duque Adeje Tenerife', lat: 28.0914, lng: -16.7389, desc: 'Premier bain. Sable dor\u00e9, eau calme \u00e0 22\u00b0C. La plus belle plage du sud.' },
          { time: '19:30', period: 'Soir', name: 'Balade littorale vers La Caleta', query: 'La Caleta de Adeje Tenerife', lat: 28.1011, lng: -16.7555, desc: '20 min \u00e0 pied depuis Playa del Duque, le long du littoral.' },
          { time: '20:30', period: 'Soir', name: 'D\u00eener \u00e0 La Caleta', query: 'La Caleta de Adeje restaurant', lat: 28.1011, lng: -16.7555, desc: 'Village de p\u00eacheurs authentique. Poisson grill\u00e9, papas arrugadas con mojo.' },
          { time: '21:15', period: 'Soir', name: 'Coucher de soleil La Caleta', query: 'La Caleta de Adeje sunset', lat: 28.1011, lng: -16.7555, desc: 'La Caleta fait face plein ouest \u2014 le soleil plonge derri\u00e8re La Gomera. Top 5 sunset de l\'\u00eele.' },
        ],
        restaurants: [
          { name: 'Restaurant La Caleta', query: 'Restaurante La Caleta de Adeje Tenerife', lat: 28.1011, lng: -16.7555, cuisine: 'Poisson & fruits de mer', priceRange: '\u20AC\u20AC', desc: 'Poisson grill\u00e9 du jour, papas arrugadas con mojo, dans le village de p\u00eacheurs face au sunset.' },
        ],
      },
      // ===== JOUR 2 — Jeudi 5 juin : Le Teide + Sunset Mirador La Tarta =====
      {
        ...
        activities: [
          ...
          { time: '07:20', period: 'Matin', name: 'Mirador de los Azulejos', query: 'Mirador de los Azulejos Tenerife', lat: 28.1660, lng: -16.6570, desc: 'Roches hydrothermales bleu-vert en bord de route. Arr\u00eat rapide 2 min.' },
          ...
          { time: '14:00', period: 'Apr\u00e8s-midi', name: 'Mirador de Chipeque', query: 'Mirador de Chipeque Tenerife', lat: 28.3530, lng: -16.4940, desc: 'Mer de nuages sous vos pieds, Teide derri\u00e8re. L\'un des plus beaux viewpoints d\'Europe. 1 830 m.' },
          ...
          { time: '19:30', period: 'Soir', name: 'Mirador de La Tarta', query: 'Mirador de La Tarta Tenerife', lat: 28.3060, lng: -16.5560, desc: 'Strates volcaniques multicolores fa\u00e7on "g\u00e2teau".' },
          { time: '20:45', period: 'Soir', name: 'Sunset au Mirador La Tarta', query: 'Mirador de La Tarta sunset Tenerife', lat: 28.3060, lng: -16.5560, desc: 'Le ciel s\'embrase sur les couches g\u00e9ologiques. Polaire obligatoire (~10\u00b0C \u00e0 1 800 m).' },
      ...
      // ===== JOUR 3 — Vendredi 6 juin : Whale watching, plage secr\u00e8te, quad sunset =====
      {
        ...
        date: '2026-06-06',
        activities: [
          { time: '08:00', period: 'Matin', name: 'D\u00e9part vers Los Gigantes', query: 'Los Gigantes Tenerife', lat: 28.2407, lng: -16.8375, desc: 'D\u00e9part Costa Adeje \u2192 Los Gigantes (30-40 min).' },
          { time: '09:00', period: 'Matin', name: 'Whale Wise Eco Tours', query: 'Whale Wise Eco Tours Los Gigantes Tenerife', lat: 28.2468, lng: -16.8414, desc: 'Whale watching \u00e9co : bateau hybride \u00e9lectrique, max 10 passagers, biologiste marine. 2h30. Baleines pilotes + dauphins garantis. Falaises depuis la mer.' },
          { time: '12:00', period: 'Apr\u00e8s-midi', name: 'Mirador de Archipenque', query: 'Mirador de Archipenque Tenerife', lat: 28.2385, lng: -16.8390, desc: 'Meilleur point de vue terrestre sur les falaises de Los Gigantes. 5 min.' },
          { time: '12:30', period: 'Apr\u00e8s-midi', name: 'D\u00e9jeuner + Playa de los Gu\u00edos', query: 'Playa de los Guíos Los Gigantes Tenerife', lat: 28.2452, lng: -16.8395, desc: 'D\u00e9jeuner \u00e0 Los Gigantes + plage de sable noir au pied des falaises.' },
          ...
          { time: '14:30', period: 'Apr\u00e8s-midi', name: 'Playa Diego Hern\u00e1ndez', query: 'Playa Diego Hernández Tenerife', lat: 28.1086, lng: -16.7612, desc: 'Marche 20 min depuis La Caleta. Sable blanc, eau turquoise, vue sur La Gomera. Plage secr\u00e8te accessible uniquement \u00e0 pied.' },
        ...
        restaurants: [
          { name: 'Restaurant Los Gigantes', query: 'Restaurante Los Gigantes Tenerife', lat: 28.2407, lng: -16.8375, cuisine: 'Poisson frais', priceRange: '\u20AC\u20AC', desc: 'Poisson frais au pied des falaises de Los Gigantes.' },
        ],
      },
      // ===== JOUR 4 — Samedi 7 juin : Grande travers\u00e9e sud \u2192 nord =====
      {
        ...
        activities: [
          ...
          { time: '07:30', period: 'Matin', name: 'Punta de Teno', query: 'Faro de Punta de Teno Tenerife', lat: 28.3421, lng: -16.9229, desc: 'Le phare au bout du monde. Route spectaculaire creus\u00e9e dans la falaise. Vagues sur les roches, impression de fin du monde. 30-45 min.' },
          ...
          { time: '09:35', period: 'Matin', name: 'Village de Masca', query: 'Masca village Tenerife', lat: 28.3060, lng: -16.8400, desc: '"Machu Picchu espagnol". Village perch\u00e9 dans les falaises. 30-45 min de balade.' },
          ...
          { time: '10:50', period: 'Matin', name: 'Charco Verde', query: 'Charco Verde Buenavista Tenerife', lat: 28.3780, lng: -16.8460, desc: 'Piscine naturelle secr\u00e8te, non r\u00e9f\u00e9renc\u00e9e sur Maps.' },
      ...
      // ===== JOUR 5 — Dimanche 8 juin : C\u00f4te nord =====
      {
        ...
        activities: [
          ...
          { time: '09:00', period: 'Matin', name: 'Playa El Bollullo', query: 'Playa El Bollullo Tenerife', lat: 28.4030, lng: -16.5200, desc: 'Sable noir volcanique fin, falaises vertigineuses, chiringuito avec vue. Sentier raide ~15 min de descente. Ambiance sauvage.' },
          ...
          { time: '12:00', period: 'Apr\u00e8s-midi', name: 'Retour parking + route Rambla de Castro', query: 'Rambla de Castro Tenerife', lat: 28.3870, lng: -16.5400, desc: '10 min de route.' },
          { time: '12:15', period: 'Apr\u00e8s-midi', name: 'Randonn\u00e9e Rambla de Castro', query: 'Rambla de Castro hiking Tenerife', lat: 28.3870, lng: -16.5400, desc: 'Zone prot\u00e9g\u00e9e. Balade 1h30-2h : falaises, palmiers, dragonniers, ascenseur d\'eau de Gordejuela, Playa Castro avec cascade. Fort\u00edn de San Fernando.' },
          ...
          { time: '17:00', period: 'Soir', name: 'Route vers Bajamar', query: 'Bajamar Tenerife', lat: 28.4920, lng: -16.3520, desc: '15 min.' },
          { time: '17:15', period: 'Soir', name: 'Piscines naturelles de Bajamar', query: 'Piscinas naturales Bajamar Tenerife', lat: 28.4920, lng: -16.3520, desc: 'Bassins creus\u00e9s dans la roche volcanique, aliment\u00e9s par l\'oc\u00e9an. Moins touristiques que Garachico. Acc\u00e8s gratuit.' },
        ...
        restaurants: [
          { name: 'Chiringuito El Bollullo', query: 'Chiringuito Playa El Bollullo Tenerife', lat: 28.4030, lng: -16.5200, cuisine: 'Bar de plage', priceRange: '\u20AC', desc: 'Caf\u00e9 ou bi\u00e8re avec vue sur la plage sauvage. Ambiance d\u00e9contract\u00e9e.' },
      ...
      // ===== JOUR 6 — Lundi 9 juin : For\u00eat d'Anaga, Taborno & Benijo =====
      {
        ...
        activities: [
          ...
          { time: '08:45', period: 'Matin', name: 'Mirador Pico del Ingl\u00e9s', query: 'Mirador Pico del Inglés Anaga Tenerife', lat: 28.5230, lng: -16.2780, desc: 'Vue 360\u00b0 : montagnes d\'Anaga, Teide en arri\u00e8re-plan.' },
          { time: '09:15', period: 'Matin', name: 'Cruz del Carmen \u2014 Sendero de los Sentidos', query: 'Cruz del Carmen Sendero de los Sentidos Tenerife', lat: 28.5170, lng: -16.2850, desc: 'Boucle 45 min dans la laurisilva mill\u00e9naire. Passerelles, ambiance de conte de f\u00e9es.' },
          ...
          { time: '12:30', period: 'Apr\u00e8s-midi', name: 'Route vers Taganana', query: 'Taganana Tenerife', lat: 28.5560, lng: -16.2150, desc: '20 min.' },
          { time: '13:00', period: 'Apr\u00e8s-midi', name: 'D\u00e9jeuner Taganana', query: 'Casa Africa Taganana Tenerife', lat: 28.5560, lng: -16.2150, desc: 'Poisson du jour. Casa Africa ou El Mirador de Aguaide. Menu ~12 \u20ac.' },
          { time: '14:00', period: 'Apr\u00e8s-midi', name: 'Route vers Benijo', query: 'Benijo Tenerife', lat: 28.5730, lng: -16.1820, desc: '10 min.' },
          { time: '14:05', period: 'Apr\u00e8s-midi', name: 'Mirador de Aguaide', query: 'Mirador de Aguaide Tenerife', lat: 28.5620, lng: -16.1850, desc: 'Vue spectaculaire sur les falaises d\'Anaga plongeant dans l\'Atlantique, les Roques de Anaga au loin. 10-15 min.' },
          { time: '14:15', period: 'Apr\u00e8s-midi', name: 'Playa de Benijo', query: 'Playa de Benijo Tenerife', lat: 28.5730, lng: -16.1820, desc: 'Sable noir volcanique, totalement sauvage, Roques de Anaga \u2014 deux pitons rocheux. Acc\u00e8s par 121 marches. Spot de contemplation.' },
        ...
        restaurants: [
          { name: 'Casa Africa', query: 'Casa Africa Taganana Tenerife', lat: 28.5560, lng: -16.2150, cuisine: 'Poisson frais', priceRange: '\u20AC', desc: 'Poisson du jour \u00e0 Taganana. Menu ~12 \u20ac. Ambiance village de p\u00eacheurs.' },
          { name: 'El Mirador de Aguaide', query: 'El Mirador de Aguaide restaurant Tenerife', lat: 28.5620, lng: -16.1860, cuisine: 'Poisson frais', priceRange: '\u20AC', desc: 'Restaurant avec vue sur les falaises d\'Anaga.' },
        ],
      },
      // ===== JOUR 7 — Mardi 10 juin : Las Teresitas, Bocacangrejo & d\u00eener d'adieu =====
      {
        ...
        activities: [
          ...
          { time: '13:00', period: 'Apr\u00e8s-midi', name: 'Route vers Bocacangrejo', query: 'Bocacangrejo Tenerife', lat: 28.4050, lng: -16.3350, desc: '15 min sud.' },
          { time: '13:15', period: 'Apr\u00e8s-midi', name: 'Bocacangrejo', query: 'Bocacangrejo cave village Tenerife', lat: 28.4050, lng: -16.3350, desc: 'Village troglodyte, maisons-cavernes dans la lave noire. 30-45 min de visite.' },
          ...
          { time: '19:30', period: 'Soir', name: 'D\u00eener d\'adieu \u2014 Los Abrigos', query: 'Los Abrigos Tenerife restaurant', lat: 28.0640, lng: -16.4570, desc: 'Village de p\u00eacheurs, 15 min de TFS. Poisson frais sur le front de mer.' },
          { time: '21:15', period: 'Soir', name: 'Dernier coucher de soleil', query: 'Los Abrigos sunset Tenerife', lat: 28.0640, lng: -16.4570, desc: 'Dernier sunset du voyage.' },
        ...
        restaurants: [
          ...
          { name: 'Restaurant Los Abrigos', query: 'Restaurante Los Abrigos Tenerife', lat: 28.0640, lng: -16.4570, cuisine: 'Poisson & fruits de mer', priceRange: '\u20AC\u20AC', desc: 'D\u00eener d\'adieu. Poisson frais sur le front de mer. Village de p\u00eacheurs \u00e0 15 min de l\'a\u00e9roport.' },
        ],
      },
    ],
  };
